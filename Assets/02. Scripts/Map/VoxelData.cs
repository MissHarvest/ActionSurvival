...
public class VoxelData : ScriptableObject
{
    ...
    public readonly Vector3[] voxelVerts = new Vector3[]
    {
        new(0f, 0f, 0f),
        new(1f, 0f, 0f),
        new(1f, 1f, 0f),
    ...
    public readonly int[][] voxelTris = new int[][]
    {
        new int[]{ 0, 3, 1, 2 },
        new int[]{ 5, 6, 4, 7 },
        new int[]{ 3, 7, 2, 6 },
    ...
    public readonly Vector2[] voxelUVs = new Vector2[]
    {
        new(0f, 0f),
        new(0f, 1f),
        new(1f, 0f),
    ...
    public readonly Vector3[] faceChecks = new Vector3[]
    {
        new( 0.0f,  0.0f, -1.0f),
        new( 0.0f,  0.0f, +1.0f),
        new( 0.0f, +1.0f,  0.0f),
